classdef Simulation < handle
    ...
    methods
        ...
        function Reset(obj)
            ...
            for i = 1:1:obj.Us
                ...
                if(obj.Us >= obj.ctrlReact)
                    obj.alpha = obj.alphaSS./(1 + (obj.k.*obj.Us./obj.Fs).^obj.h);
                end
        ...
        function RunOnce(obj)
            ...
            %Step 2: Run
            EndSim = false;
            dataArr = [obj.Tnow,obj.Us,obj.Ps,obj.FsCreated,obj.Fs,obj.alphaOpt,obj.alphaSS,0,obj.repNumber];
        ...
        function PullFutureEvents(obj)
            ...
            pause (0.00000000000000000000000000000000000000000000000000001);
        ...
        function TreatFArrival(obj)
            ...
            if (obj.DL1.size > 0)
                ...
                u = rand();
                if(obj.Us >= obj.ctrlReact)
                    obj.alpha = obj.alphaSS./(1 + (obj.k.*obj.Us./obj.Fs).^obj.h);%obj.alpha = obj.alphaSS./(1 + (obj.k.*obj.Us./obj.Fs.*obj.fArr(1)./obj.uArr()).^obj.h);
                end
                if(u <= obj.alpha)
                    obj.CreateU(curU);
                else
            ...
            dataArr = [obj.Tnow,obj.Us,obj.Ps,obj.FsCreated,obj.Fs,obj.alpha,obj.alphaSS,toc(obj.timerVal),obj.repNumber];
            %obj.unTrnsDataU.AddRow(dataArr);
            obj.unTrnsDataAlfa.AddRow(dataArr);
        end
        ...
        function TreatEndOfMakingU(obj)
            ...
            if (obj.Us == obj.envChange)
                obj.fArr = obj.fArr.*obj.envFactor;
