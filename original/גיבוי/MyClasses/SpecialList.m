classdef SpecialList < handle
    ...
    methods
        ...
        %----------------------------
        function Enque(obj,specialEntity)
            toBeInserted = SpecialNode(specialEntity);
            if (obj.size > 0)
        ...
        function SmartEnque(obj,entity)
            ...
            toBeInserted = SpecialNode(entity);
            iNod = obj.last;
            isInserted = false;
        ...
        function ret = InsertAfter(obj,afterWho, data)
            ...
            toBeInserted = SpecialNode(data);           % Creating new node
